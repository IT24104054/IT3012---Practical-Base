...
class VisualGridHuntGame:
    ...
    def get_percept(self) -> dict:
        ...
        return {
            ...
            'target_positions': list(self.food_positions),
            'dust_positions': list(self.toxic_traps),
            'bloodseeker_positions': [tuple(opponent) for opponent in self.opponents],
            'bloodseeker_missing': not self.opponents
        }
